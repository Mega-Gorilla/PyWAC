...
[![Version](https://img.shields.io/badge/Version-1.0.0-blue?style=for-the-badge)](https://github.com/Mega-Gorilla/pywac)
...
- **リアルタイム録音**: 循環バッファによる常時録音（過去N秒を保存可能）
- 録音時間設定（1～60秒）とプリセットボタン（5秒/10秒/30秒）
- リアルタイム録音では連続録音の停止ボタンを提供
